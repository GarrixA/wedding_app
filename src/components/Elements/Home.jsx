				...
				<motion.div className="relative w-full h-[70%] sm:h-[90%] p-3 -top-24 lg:-top-10 flex items-center justify-center">
					<AnimatePresence custom={direction}>
						<motion.div
							...
							className="absolute -top-[20%] lg:top-[17% z-0 h-96 w-full lg:w-[50%] md:px-[10%] lg:px-[0%] left-0 lg:left-[50%] cursor-pointer rounded overflow-hidden flex flex-col justify-center px-4"
					...
					<AnimatePresence custom={direction}>
						<motion.div
							...
							className="absolute -bottom-[20%] lg:bottom-[17% h-96 justify-start items-start left-0 sm:w-full md:w-full md:px-[10%] lg:px-[0%] lg:w-[50%] lg:left-[0%] lg:justify-center cursor-pointer rounded overflow-hidden flex flex-col sm:px-0 px-4"
							variants={slideVariants}
							initial="initial"
							animate="animate"
							exit="exit"
