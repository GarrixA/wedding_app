			...
			<motion.div className="home relative mx-[10%] h-screen lg:h-screen sm:h-[90vh] flex items-center mt-5">
				<AnimatePresence>
					<motion.h1
						...
						className="font-black w-full top-[35%] sm:top-[40%] text-sm sm:text-4xl absolute text-center sm:w-full  z-50  bg-[#FECB64] lg:bg-transparent flex items-center justify-center lg:justify-start px-4 rounded  lg:top-4"
				...
				<motion.div className="relative w-full h-[70%] sm:h-[90%] p-3 -top-24 lg:-top-10 flex items-center justify-center">
					<AnimatePresence custom={direction}>
						<motion.div
							...
							className="absolute -top-[20%] lg:top-[17% z-0 h-96 w-full lg:w-[50%] md:px-[10%] lg:px-[0%] left-0 lg:left-[50%] cursor-pointer rounded overflow-hidden flex flex-col justify-center px-4 bg-green-500"
					...
					<AnimatePresence custom={direction}>
						<motion.div
							...
							className=" absolute z-10 sm:w-full md:w-full lg:w-[60%] lg:h-[60%] lg:left-[20%] cursor-pointer sm:rounded rounded-3xl overflow-hidden shadow-md left-0 w-full h-[50%] md:h-[50%] xl:h-[70%] sm:mt-0 bg-blue-900"
							variants={slideVariants}
							initial="initial"
							animate="animate"
							exit="exit"
					...
					<AnimatePresence custom={direction}>
						<motion.div
							...
							className="absolute -bottom-[20%] lg:bottom-[17% h-96 justify-start items-start left-0 sm:w-full md:w-full md:px-[10%] lg:px-[0%] lg:w-[50%] lg:left-[0%] lg:justify-center cursor-pointer rounded overflow-hidden flex flex-col sm:px-0 px-4 bg-red-600"
							variants={slideVariants}
							initial="initial"
							animate="animate"
							exit="exit"
				...
				<button
					...
					className="prev absolute sm:-left-[8%] -left-[10%] top-[35%] sm:top-[50%] md:top-[45%] transform -translate-y-1/2 bg-black text-white sm:p-2 p-1 rounded-full z-50"
				>
					<GrPrevious />
				</button>
				<button
					onClick={() => handleNext(setCurrentIndex, setDirection, album)}
					className="next absolute sm:-right-[8%] -right-[10%] top-[35%] sm:top-[50%] md:top-[45%] transform -translate-y-1/2 bg-black text-white sm:p-2 p-1 rounded-full z-50"
				>
					<GrNext />
				</button>
			</motion.div>
